...
namespace ColMarkSort.Model.Etabs
{
    public static class ManageEtabs
    {
        ...
        public static ColumnArrayGroup GetDataFromEtabs()
        {
            ...
            //get unique columns properties 
            //not all frames in the model but the frames defined
            ...
            for (int i = 0; i < numberNames; i++)
            {
                ...
                if (myType == 1) //used to filter column elements only
                {
                    ...
                    IsCircular = false;
                    T3 = 0; // reset the T3 for next column
                    T2 = 0; // reset the T2 for next column
                }
            ...
            var test = columnArrayGroup.ColumnsArrays;
